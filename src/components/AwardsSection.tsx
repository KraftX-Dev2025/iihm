            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-16">
                    <div className="bg-white/10 backdrop-blur-sm rounded-xl p-6 text-center hover:bg-white/20 transition-all">
                        ...
                        />
                        <p className="text-sm">
                            Economics Times - Best Hospitality Education Brand
                            2018, 2019, 2020, 2021
                        </p>
                    </div>
                    ...
                    <div className="bg-white/10 backdrop-blur-sm rounded-xl p-6 text-center hover:bg-white/20 transition-all">
                        ...
                        />
                        <p className="text-sm">
                            Forbes India - Great Place to Study & Great Indian
                    ...
                    <div className="bg-white/10 backdrop-blur-sm rounded-xl p-6 text-center hover:bg-white/20 transition-all">
                        ...
                        />
                        <p className="text-sm">
                            Zee 24 Ghanta - Zee Education Excellence Awards as
                            Best Hospitality Education Brand
                        </p>
                    </div>
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                    <div className="bg-white/10 backdrop-blur-sm rounded-xl p-6 text-center hover:bg-white/20 transition-all">
                        ...
                        />
                        <p className="text-sm">
                            Et Now - IIHM's founder Dr. Suborno Bose as Business
                            Leader of the Year
                        </p>
                    </div>
                ...
                <div className="mt-16 text-center">
                    <h3 className="text-3xl font-bold mb-8">Recognized By</h3>
                    <div className="flex flex-wrap justify-center items-center gap-12 bg-white/10 backdrop-blur-sm rounded-xl p-8">
                        <img
